...
export default function GraciasPage() {
  return (
    <>
      <Head>
        <title>¡Gracias por tu reserva! | Blanc & Co</title>
        <meta name="description" content="Gracias por reservar en Blanc & Co. Confirma tu pago y agenda tu cita de blanqueamiento dental." />
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href="https://blancnco.mx/reservar/gracias" />
      </Head>
